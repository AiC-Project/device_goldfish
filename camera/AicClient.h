...
#ifndef HW_EMULATOR_CAMERA_AIC_CLIENT_H
#define HW_EMULATOR_CAMERA_AIC_CLIENT_H
 ...
 */
class CameraAicClient : public AicClient {
public:
    /* Constructs CameraQemuClient instance. */
    CameraAicClient();

    /* Destructs CameraAicClient instance. */
    ~CameraAicClient();
...
#endif  /* HW_EMULATOR_CAMERA_AIC_CLIENT_H */
